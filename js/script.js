...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.body.addEventListener("mousedown", initializeAudioContext, { once: true });
    document.body.addEventListener("keydown", initializeAudioContext, { once: true });
    ...
    function playNote(keyElement, frequency) {
        ...
        if (!oscillators[note]) {
            ...
            switch (currentInstrumentType) {
                case "choir":
                    oscillator.type = "sine"; // Pure tone, good for vocal approximation
                    gainNode.gain.linearRampToValueAtTime(
                        0.5,
                        audioCtx.currentTime + 0.2
                    ); // Slow/Fast attack for choir
                    break;
                case "organ":
                ...
                case "flute":
                    ...
                    break;
                default: // Fallback to choir if something goes wrong
